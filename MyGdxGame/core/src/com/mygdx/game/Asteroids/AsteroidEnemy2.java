...
public  class AsteroidEnemy2 extends Enemy {
    ...
    public AsteroidEnemy2 (PlayScreen screen, float x, float y) {
        super(screen, x, y);
        this.world = screen.getWorld();
        Array<TextureRegion> frames = new Array<TextureRegion>();
        for (int i = 0; i < 16; i++)
            frames.add(new TextureRegion(screen.getAtlas4().findRegion("rock2"), i * 66, 0, 64, 64));
       ...
       ;
        ...
        shipStand = new TextureRegion(screen.getAtlas4().findRegion("rock2") ,64,0,64,64 );
        setBounds(x, y, 78 / MyGdxGame.PPM , 78 / MyGdxGame.PPM );
        stateTimer = 0;
        setDestroyd = false;
        destroyed = false;
