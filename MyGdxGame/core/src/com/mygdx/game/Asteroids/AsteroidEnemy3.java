...
public  class AsteroidEnemy3 extends Enemy {
    ...
    public AsteroidEnemy3 (PlayScreen screen, float x, float y) {
        super(screen, x, y);
        this.world = screen.getWorld();
        Array<TextureRegion> frames = new Array<TextureRegion>();
        for (int i = 0; i < 16; i++)
            frames.add(new TextureRegion(screen.getAtlas4().findRegion("rock3"), i * 66, 0, 64, 64));
        ...
        shipStand = new TextureRegion(screen.getAtlas4().findRegion("rock3") ,64,0,64,64 );
