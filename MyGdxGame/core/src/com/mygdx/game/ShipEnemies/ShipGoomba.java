...
import com.mygdx.game.Other.LaserGumba;
import com.mygdx.game.Scenes.Hud;
import com.mygdx.game.Screens.PlayScreen;

public  class ShipGoomba extends Sprite {
    World world;
    Body b2body;
   ...
   private   boolean setDestroyd;
    ...
    private Array<LaserGumba> laserShoot1;
    ...
    public ShipGoomba(PlayScreen screen,float x, float y) {
        ...
        for (int i = 0; i < 16; i++)
            frames.add(new TextureRegion(screen.getAtlas1().findRegion("strip_spikey"), i * 128, 0, 128, 128));
        ...
        shipStand = new TextureRegion(screen.getAtlas1().findRegion("strip_spikey"), 128, 0, 128,128 );
        ...
        destroyed = false;
         defineGomba();
        laserShoot1 = new Array<LaserGumba>();


    }
    public void defineGomba() {
        ...
        fdef.filter.categoryBits = MyGdxGame.SHIP_GUMBA1;
